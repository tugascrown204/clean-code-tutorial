# Contributing to Clean Code Tutorial
...
6. **Create a pull request**: Submit your changes back to the original repository for review. **Include a detailed description of your changes (what was done), the motivation behind them, and any relevant context for the reviewers. Reference related issue numbers as applicable and follow standard commit message formats like `Fixes #issue_number`, linking any associated issues.**
